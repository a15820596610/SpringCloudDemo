...
public class DataSourceForOrcl {
    @Value("${spring.datasource.orcl.jdbc-url}")
    private String dbUrl;
    @Value("${spring.datasource.orcl.username}")
    private String username;
    @Value("${spring.datasource.orcl.password}")
    private String password;
    @Value("${spring.datasource.orcl.driver-class-name}")
...
//        druidXADataSource.setMaxWait(maxWait);
        ...
        xaDataSource.setUniqueResourceName("data2Source");
        return xaDataSource;
    }
